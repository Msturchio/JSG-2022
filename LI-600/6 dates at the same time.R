...
df<-read.csv("Master_LI600_6.csv")
...
tiff(file = "1x6 whole enchilada.tiff", height = 4, width = 14, res = 400, units = "in", compression = "zip+p")
par(mfrow = c(1,6), omi = c(0.8, 1.2, 0.4, 0.1), mar = c(1.5,1,0.5,0.5))
...
mtext(side = 1, expression("9am     11am   1pm   3pm    5pm"), cex = 0.8, padj = 1.25, outer= F)
